    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-4 py-16 md:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        <div className="flex flex-col gap-4">
          <Reveal delay={100} className="animate-float rounded-2xl border border-border bg-card/70 p-5 backdrop-blur-xl">
          ...
          <Reveal delay={200} className="rounded-2xl border border-gold/25 bg-card/70 p-5 backdrop-blur-xl">
            <div className="flex items-center justify-between">
